...
4. Let GitHub Actions restore with explicit NuGet and Dalamud package sources, build the plugin from `main`, validate the packaged manifest, and publish the stable `latest` GitHub Release.
